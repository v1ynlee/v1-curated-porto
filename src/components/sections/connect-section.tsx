  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse, var(--p-glow-soft), transparent)",
        }}
      />
        ...
        <div className="text-center mb-16">
          ...
          <BlurFade delay={0.15} inView>
            <p className="max-w-md mx-auto text-[var(--muted-foreground)]">
              Drop by any of my socials — I&apos;m always happy to talk about
              manhwa, manga, and manhua recommendations.
            </p>
          </BlurFade>
        </div>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-1.5 mb-0.5">
                        <p
                          className={`font-semibold text-[var(--foreground)] text-sm transition-colors duration-200 ${link.hoverText}`}
                        >
                          {link.name}
                        </p>
                        <ExternalLink
